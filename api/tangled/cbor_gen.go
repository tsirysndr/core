...
func (t *CiPipeline) MarshalCBOR(w io.Writer) error {
	...
	if _, err := cw.WriteString(string(t.Commit)); err != nil {
		return err
	}
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("trigger"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("trigger")); err != nil {
		return err
	}

	if err := t.Trigger.MarshalCBOR(cw); err != nil {
		return err
	}
...
func (t *CiPipeline_Trigger) MarshalCBOR(w io.Writer) error {
	...
	// t.CiTrigger_Push (tangled.CiTrigger_Push) (struct)
	if len("CiTrigger_Push") > 1000000 {
		return xerrors.Errorf("Value in field \"CiTrigger_Push\" was too long")
	}

	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("CiTrigger_Push"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("CiTrigger_Push")); err != nil {
		return err
	}

	if err := t.CiTrigger_Push.MarshalCBOR(cw); err != nil {
		return err
	}

	// t.CiTrigger_Manual (tangled.CiTrigger_Manual) (struct)
	if len("CiTrigger_Manual") > 1000000 {
		return xerrors.Errorf("Value in field \"CiTrigger_Manual\" was too long")
	}

	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("CiTrigger_Manual"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("CiTrigger_Manual")); err != nil {
		return err
	}

	if err := t.CiTrigger_Manual.MarshalCBOR(cw); err != nil {
		return err
	}

	// t.CiTrigger_PullRequest (tangled.CiTrigger_PullRequest) (struct)
	if len("CiTrigger_PullRequest") > 1000000 {
		return xerrors.Errorf("Value in field \"CiTrigger_PullRequest\" was too long")
	}

	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("CiTrigger_PullRequest"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("CiTrigger_PullRequest")); err != nil {
		return err
	}

	if err := t.CiTrigger_PullRequest.MarshalCBOR(cw); err != nil {
		return err
	}
	return nil
}
		...
		case "CiTrigger_Push":

			{
				...
				if b != cbg.CborNull[0] {
					...
					if err := t.CiTrigger_Push.UnmarshalCBOR(cr); err != nil {
						return xerrors.Errorf("unmarshaling t.CiTrigger_Push pointer: %w", err)
					}
				}

			}
			// t.CiTrigger_Manual (tangled.CiTrigger_Manual) (struct)
		case "CiTrigger_Manual":

			{
				...
				if b != cbg.CborNull[0] {
					...
					if err := t.CiTrigger_Manual.UnmarshalCBOR(cr); err != nil {
						return xerrors.Errorf("unmarshaling t.CiTrigger_Manual pointer: %w", err)
					}
				}

			}
			// t.CiTrigger_PullRequest (tangled.CiTrigger_PullRequest) (struct)
		case "CiTrigger_PullRequest":

			{
				...
				if b != cbg.CborNull[0] {
					...
					if err := t.CiTrigger_PullRequest.UnmarshalCBOR(cr); err != nil {
						return xerrors.Errorf("unmarshaling t.CiTrigger_PullRequest pointer: %w", err)
					}
				}
...
func (t *CiSubscribePipelineLogs_Control) MarshalCBOR(w io.Writer) error {
	...
	// t.Step (int64) (int64)
	if len("step") > 1000000 {
		return xerrors.Errorf("Value in field \"step\" was too long")
	}

	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("step"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("step")); err != nil {
		return err
	}
	...
	if t.Step >= 0 {
		...
		if err := cw.WriteMajorTypeHeader(cbg.MajNegativeInt, uint64(-t.Step-1)); err != nil {
			return err
		}
	}
...
func (t *CiSubscribePipelineLogs_Data) MarshalCBOR(w io.Writer) error {
	...
	// t.Stream (string) (string)
	if len("stream") > 1000000 {
		return xerrors.Errorf("Value in field \"stream\" was too long")
	}

	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("stream"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("stream")); err != nil {
		return err
	}

	if len(t.Stream) > 1000000 {
		return xerrors.Errorf("Value in field t.Stream was too long")
	}

	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len(t.Stream))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string(t.Stream)); err != nil {
		return err
	}
...
func (t *CiTrigger_PullRequest) MarshalCBOR(w io.Writer) error {
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("sh.tangled.ci.trigger#pullRequest"))); err != nil {
		return err
	}
...
func (t *CiTrigger_PullRequest) UnmarshalCBOR(r io.Reader) (err error) {
	*t = CiTrigger_PullRequest{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("CiTrigger_PullRequest: map struct too large (%d)", extra)
	}
...
func (t *CiTrigger_Push) MarshalCBOR(w io.Writer) error {
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("sh.tangled.ci.trigger#push"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("sh.tangled.ci.trigger#push")); err != nil {
		return err
	}
...
func (t *CiTrigger_Push) UnmarshalCBOR(r io.Reader) (err error) {
	*t = CiTrigger_Push{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("CiTrigger_Push: map struct too large (%d)", extra)
	}
...
func (t *FeedSubscription) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("sh.tangled.feed.subscription"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("sh.tangled.feed.subscription")); err != nil {
		return err
	}

	// t.Subject (tangled.FeedSubscription_Subject) (struct)
	if len("subject") > 1000000 {
		return xerrors.Errorf("Value in field \"subject\" was too long")
	}
	...
	// t.Collections ([]string) (slice)
	if t.Collections != nil {

		if len("collections") > 1000000 {
			return xerrors.Errorf("Value in field \"collections\" was too long")
		}

		if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("collections"))); err != nil {
			return err
		}
		if _, err := cw.WriteString(string("collections")); err != nil {
			return err
		}

		if len(t.Collections) > 8192 {
			return xerrors.Errorf("Slice value in field t.Collections was too long")
		}

		if err := cw.WriteMajorTypeHeader(cbg.MajArray, uint64(len(t.Collections))); err != nil {
			return err
		}
		for _, v := range t.Collections {
			if len(v) > 1000000 {
				return xerrors.Errorf("Value in field v was too long")
			}
...
func (t *FeedSubscription) UnmarshalCBOR(r io.Reader) (err error) {
	*t = FeedSubscription{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("FeedSubscription: map struct too large (%d)", extra)
	}
	...
	for i := uint64(0); i < n; i++ {
		...
		case "subject":

			{
				...
				if b != cbg.CborNull[0] {
					...
					t.Subject = new(FeedSubscription_Subject)
					if err := t.Subject.UnmarshalCBOR(cr); err != nil {
						return xerrors.Errorf("unmarshaling t.Subject pointer: %w", err)
					}
				}
		...
		case "collections":
			...
			if extra > 8192 {
				return fmt.Errorf("t.Collections: array too large (%d)", extra)
			}
			...
			if extra > 0 {
				t.Collections = make([]string, extra)
			}
...
func (t *FeedSubscription_Uri) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("sh.tangled.feed.subscription#uri"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("sh.tangled.feed.subscription#uri")); err != nil {
		return err
	}
	return nil
}

func (t *FeedSubscription_Uri) UnmarshalCBOR(r io.Reader) (err error) {
	*t = FeedSubscription_Uri{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("FeedSubscription_Uri: map struct too large (%d)", extra)
	}
...
func (t *FeedSubscription_Repo) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("sh.tangled.feed.subscription#repo"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("sh.tangled.feed.subscription#repo")); err != nil {
		return err
	}
	return nil
}

func (t *FeedSubscription_Repo) UnmarshalCBOR(r io.Reader) (err error) {
	*t = FeedSubscription_Repo{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("FeedSubscription_Repo: map struct too large (%d)", extra)
	}
...
func (t *KnotMemberAcceptance) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("sh.tangled.knot.memberAcceptance"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("sh.tangled.knot.memberAcceptance")); err != nil {
		return err
	}
...
func (t *KnotMemberAcceptance) UnmarshalCBOR(r io.Reader) (err error) {
	*t = KnotMemberAcceptance{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("KnotMemberAcceptance: map struct too large (%d)", extra)
	}
...
func (t *KnotMemberInvite) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("sh.tangled.knot.memberInvite"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("sh.tangled.knot.memberInvite")); err != nil {
		return err
	}
...
func (t *KnotMemberInvite) UnmarshalCBOR(r io.Reader) (err error) {
	*t = KnotMemberInvite{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("KnotMemberInvite: map struct too large (%d)", extra)
	}
...
func (t *RepoCollaboratorAcceptance) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("sh.tangled.repo.collaboratorAcceptance"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("sh.tangled.repo.collaboratorAcceptance")); err != nil {
		return err
	}
...
func (t *RepoCollaboratorAcceptance) UnmarshalCBOR(r io.Reader) (err error) {
	*t = RepoCollaboratorAcceptance{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("RepoCollaboratorAcceptance: map struct too large (%d)", extra)
	}
...
func (t *RepoCollaboratorInvite) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("sh.tangled.repo.collaboratorInvite"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("sh.tangled.repo.collaboratorInvite")); err != nil {
		return err
	}
...
func (t *RepoCollaboratorInvite) UnmarshalCBOR(r io.Reader) (err error) {
	*t = RepoCollaboratorInvite{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("RepoCollaboratorInvite: map struct too large (%d)", extra)
	}
